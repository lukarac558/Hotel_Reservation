...
public class SearchEngineActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startDateSetListener = new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(DatePicker datePicker, int year, int month, int day) {
                setDate(startDate, startDateTextView, year, month, day);
            }
        };
        ...
        endDateSetListener = new DatePickerDialog.OnDateSetListener() {
            ...
            @Override
            public void onDateSet(DatePicker datePicker, int year, int month, int day) {
                setDate(endDate, endDateTextView, year, month, day);
            }
        };
    ...
    private void setSelectedCities(){
        ...
        if(list.size() > 0) {
            for (KeyPairBoolData k : list) {
                int id = (int) k.getId();
                String name = k.getName();
                selectedCitiesList.add(new City(id, name));
            }
        }
        else
    ...
    @RequiresApi(api = Build.VERSION_CODES.O)
    private void setDate(LocalDate date, TextView textView, int year, int month, int day){
